        ...
        <div className="p-6 space-y-6">
          <ContentSection id="aims" title="Aims" icon={FaBook}>
            <p className="text-gray-700 leading-relaxed">
              The Universal Journal of Green SciTech & Management (UJGSM) aims to bridge the gap between research and practice by promoting and publishing original, high-quality studies across Science and Management disciplines. The journal welcomes contributions in:
            </p>
