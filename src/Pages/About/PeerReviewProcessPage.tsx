...
import { FaGlasses, FaPaperPlane, FaFileAlt, FaCompass, FaHome, FaBook, FaArchive, FaEnvelope, FaMapMarkerAlt, FaPhone } from 'react-icons/fa';
...
const PeerReviewProcess: React.FC = () => {
  ...
  const Sidebar = () => {
    const navItems = [
      { id: 'overview', title: 'Overview', icon: FaGlasses },
    ...
    <div className="lg:col-span-3">
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div className="p-6 space-y-6">
          <ContentSection id="overview" title="Overview" icon={FaGlasses}>
