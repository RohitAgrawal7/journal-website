        ...
        <div className="p-6 space-y-6">
          <ContentSection id="overview" title="Overview" icon={FaShieldAlt}>
            <p className="text-gray-700 leading-relaxed">
              Universal Journal of Green Sci-Tech and Management  is not a registered member of the Committee on Publication Ethics (COPE). However, UJGSM follows the best practices as defined by the Committee on Publication Ethics (COPE) and is open to the views and opinions of authors, reviewers, and editorial board members. The journal adheres to the highest academic integrity standards and always follows COPE guidelines.
            </p>
          </ContentSection>
