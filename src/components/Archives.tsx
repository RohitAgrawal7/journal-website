      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div className="p-6 space-y-6">
          ...
          <ContentSection id="accessing-content" title="Accessing Archived Content" icon={FaLink}>
            ...
            <p className="text-gray-700 leading-relaxed">
              For details on the publication schedule, including upcoming issues, refer to the <a href="#" className="text--teal-800 hover:underline">Time of Publication</a> page. To learn more about the journal’s open-access policy, visit the <a href="#" className="text--teal-800 hover:underline">Open Access Policy</a> page.
            </p>
          </ContentSection>
        </div>
      </div>
