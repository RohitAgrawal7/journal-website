      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div className="p-6 space-y-6">
          ...
          <ContentSection id="upcoming-content" title="Upcoming Content" icon={FaHourglassHalf}>
            ...
            <p className="text-gray-700 leading-relaxed">
              Authors can submit their work by the respective deadlines (e.g., September 30, 2025, for Issue 2). For more details on submission deadlines, refer to the <a href="#" className="text-eco-gold hover:underline">Time of Publication</a> page. Stay tuned for updates on forthcoming articles and special issues.
            </p>
          </ContentSection>
        </div>
      </div>
